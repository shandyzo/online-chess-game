...
import { ang2Rad, createSpotlight, getFenFromMatrixIndex, getMatrixIndexFromFen, getMeshPosition, isSamePoint, setOutline } from "../../utils/helper";
...
export default class Scene extends Component {
    componentDidMount() {
        ...
        var light = createSpotlight(spotLightProps)
        scene.add( light );
        var light2 = createSpotlight(spotLightProps2)
        scene.add( light2 );
...
/***************************outline **********************************/
        ...
        const redOutlinePass = setOutline({visibleEdgeColor : 0xcccccc, hiddenEdgeColor:0x000000,outlineParams })
        const blueOutlinePass = setOutline({visibleEdgeColor : 0xff0000, hiddenEdgeColor:0x000000, outlineParams })
